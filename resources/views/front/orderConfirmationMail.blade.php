...
$address = SavedAddressModel::where('id', $address_id)->first();
      ...
      <tbody>
        <tr style="vertical-align: top" valign="top">
          <td style="word-break: break-word; vertical-align: top" valign="top">
            ...
            <div style="background: linear-gradient(45deg, rgb(15, 213, 216), rgb(231, 22, 249)) !important">
              <div
                class="block-grid"
                style="
                  min-width: 320px;
                    ...
                    <div class="col_cont" style="width: 100% !important">
                      ...
                      >
						...
						">
							  ...
							  <p>{{$add->shipping_fname.' '.$add->shipping_lname.', '.$add->shipping_address.', '.$add->shipping_pincode.', '.$add->shipping_state.', '.$add->shipping_country}}</p>
						</div>
                        </div>
                        <!--[if (!mso)&(!IE)]><!-->
                      </div>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              Order number:
                              <span style="color: linear-gradient(45deg, rgb(15, 213, 216), rgb(231, 22, 249)) !important"
                                ><strong>{{$order_id}}</strong></span
                              >
                            </p>
                          </div>
                        </div>
                  ...
                  >
                    <div class="col_cont" style="width: 100% !important">
                      ...
                      >
                        ...
                        <div
                          style="
                            color: linear-gradient(45deg, rgb(15, 213, 216), rgb(231, 22, 249)) !important;
                            font-family: Nunito, Arial, Helvetica Neue,
                              Helvetica, sans-serif;
                            line-height: 1.2;
                            padding-top: 10px;
            ...
            @php
            $product = json_decode($productCheckout);
            @endphp
                        ...
                        >
                          ...
                          >
                            ...
                            <p
                              ...
                              "
                            >
                              {{$p->product_title}} - {{$p->product_variant}} 
                            </p>
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        >
                          ...
                          >
                            <p
                              ...
                              "
                            >
                              <span style="font-size: 16px">₹ {{json_decode($couponCheckout)[0]->subTotal}}</span>
                            </p>
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <span style="font-size: 16px"
                                ><strong>Shipping Charge</strong></span
                              >
                            </p>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          >
                            <p
                              ...
                              "
                            >
                              <span style="font-size: 16px">₹ {{empty(json_decode($couponCheckout)[0]->shippingValue) ? 0 : json_decode($couponCheckout)[0]->shippingValue}}</span>
                            </p>
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        >
                          ...
                          >
                            <p
                              ...
                              "
                            >
                              <span style="font-size: 16px">₹ -{{empty(json_decode($couponCheckout)[0]->couponValue) ? 0 : json_decode($couponCheckout)[0]->couponValue}}</span>
                            </p>
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                          ...
                          >
                            ...
                            >
                              <span style="font-size: 22px"
                                ><strong
                                  ><span style="">Total ₹ {{$paid_amount}}</span></strong
                                ></span
                              >
                            </p>
                          </div>
                        ...
                        >
                         <a
                            ...
                            style="
                              ...
                              width: auto;
                              width: auto;
                              border-top: 1px solid linear-gradient(45deg, rgb(15, 213, 216), rgb(231, 22, 249)) !important;
                              border-right: 1px solid linear-gradient(45deg, rgb(15, 213, 216), rgb(231, 22, 249)) !important;
                              border-bottom: 1px solid linear-gradient(45deg, rgb(15, 213, 216), rgb(231, 22, 249)) !important;
                              border-left: 1px solid linear-gradient(45deg, rgb(15, 213, 216), rgb(231, 22, 249)) !important;
                              padding-top: 5px;
                              padding-bottom: 5px;
                              font-family: Nunito, Arial, Helvetica Neue,
                                Helvetica, sans-serif;
