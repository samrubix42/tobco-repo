                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-sm-12 col-md-2 col-lg-3">
                                <div class="ftr-logo text-md-start">
                                    <img class="logoImg" src="{{asset('public/uploads/'.$contact->logo)}}" alt="{{config('app.name')}}" title="{{config('app.name')}}" width="149" height="39" />
                                </div>
                            </div>
         ...
         function getCart(){
             ...
             if (cartData && Array.isArray(cartData) && cartData.length > 0) {
                 ...
                 return `<li class="item d-flex justify-content-center align-items-center">
                            <a class="product-image" href="#">
                                <img class="blur-up lazyload" data-src="{{asset('public/uploads/')}}/`+cartProducts.product_image+`" src="{{asset('public/uploads/')}}/`+cartProducts.product_image+`" alt="`+ cartProducts.product_title +`" title="Product" width="120" height="170" />
                            </a>
                            <div class="product-details">
             ...
             var listItems = cartData?.map(function(cartProducts, index) {
                return `<tr class="cart-row cart-flex position-relative">
                            <td class="cart-image cart-flex-item">
                                <a href="#"><img class="cart-image rounded-0 blur-up lazyload" data-src="public/uploads/${cartProducts.product_image}" src="public/uploads/${cartProducts.product_image}" alt="${cartProducts.product_title}" width="120" height="170" /></a>
                            </td>
