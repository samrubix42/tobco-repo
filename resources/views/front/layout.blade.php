...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{asset('uploads/'.$contact->logo)}}" />
    <!-- Plugins CSS -->
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-WWM6LWR8');
    </script>
...
<body class="template-index index-demo3">
    ...
    <div class="page-wrapper">
        <header class="header header-7">
                ...
                <div class="container container-1330">
                    <div class="row align-items-center">
                                            ...
                                            <div class="d-flex searchField">
                                                <div class="search-category">
                                                    <select class="rgsearch-category rounded-end-0" name="c">
                                                        ...
                                                        <option value="{{ $c->slug }}" {{ isset($_GET['c']) && $_GET['c'] === $c->slug ? 'selected' : '' }}>
                                                            - {{ $c->title }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="d-flex fl-1">
                                                    <input type="text" class="input-text rounded-0 border-start-0 border-end-0"
                                                        name="p" placeholder="Search for products..."
                        ...
                        <div class="logo col-5 col-sm-4 col-md-2 col-lg-2 col-xl-2 align-self-center">
                            <a class="logoImg" href="{{url('/')}}"><img src="{{asset('uploads/'.$contact->logo)}}" alt="{{config('app.name')}}" title="{{config('app.name')}}" width="149" height="39" /></a>
                        </div>
                        <!--End Logo-->
                        <!--Search Inline-->
                            ...
                            <div class="col-1 col-sm-1 col-md-1 col-lg-12 align-self-center d-menu-col hdr-menu-center menu-position-center">
                                <nav class="navigation ps-lg-3" id="AccessibleNav">
                                    <ul id="siteNav" class="site-nav medium center">
                                        ...
                                        <li class="lvl1"><a href="{{url('/hookah-shop-in-noida')}}">location</a></li>
            ...
            <div style="height: 52.8px; display: none;"></div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-sm-12 col-md-2 col-lg-3">
                            <div class="ftr-logo text-md-start">
                                <img class="logoImg" src="{{asset('uploads/'.$contact->logo)}}" alt="{{config('app.name')}}" title="{{config('app.name')}}" width="149" height="39" />
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="d-flex-center flex-column justify-content-md-between flex-md-row-reverse">
                        <ul class="payment-icons d-flex-center mb-2 mb-md-0">
                            <li>
                                <div class="copytext">Powered By <a href="https://techonika.com" class="text-white">Techonika</a></div>
                            </li>
        ...
        <!-- Elevatezoom Zoom -->
        <script src="{{asset('frontend/')}}/assets/js/vendor/jquery.elevatezoom.js"></script>
            ...
            if (cartData && Array.isArray(cartData) && cartData.length > 0) {
                listItems = cartData?.map(function(cartProducts, index) {
                    return `<li class="item d-flex justify-content-center align-items-center">
                            <a class="product-image" href="#">
                                <img class="blur-up lazyload" data-src="{{asset('uploads/')}}/` + cartProducts.product_image + `" src="{{asset('uploads/')}}/` + cartProducts.product_image + `" alt="` + cartProducts.product_title + `" title="Product" width="120" height="170" />
                            </a>
                            <div class="product-details">
            ...
            var listItems = cartData?.map(function(cartProducts, index) {
                return `<tr class="cart-row cart-flex position-relative">
                            <td class="cart-image cart-flex-item">
                                <a href="#"><img class="cart-image rounded-0 blur-up lazyload" data-src="/uploads/${cartProducts.product_image}" src="/uploads/${cartProducts.product_image}" alt="${cartProducts.product_title}" width="120" height="170" /></a>
                            </td>
