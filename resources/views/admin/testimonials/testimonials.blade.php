                                            ...
                                            <div id="message"></div>
                                             <form id="testimonial-form" enctype="multipart/form-data">
                                                <div class="row">
                                                   ...
                                                   <div class="col-md-12 mb-3">
                                                      <label for="subheading">Designation</label>
                                                   ...
                                                   <div class="col-md-12 mb-3">
                                                      <label for="subheading">Upload User Image</label>
                  ...
                  <table
                                 ...
                                 <div class="row">
                                    <div class="col-12">
                                       <div class="">
                                          <div class="">
                                            <div id="message"></div>
                                             <form id="edit-testimonial-form{{$t->id}}" data-item-id="{{ $t->id }}" enctype="multipart/form-data">
                                                <div class="row">
                                                   <div class="col-md-12 mb-3">
                                                      ...
                                                      <!-- @method('PUT') -->
                                                      <label for="title">Name</label>
                                                      <input type="text" class="form-control" id="title" value="{{$t->title}}" name="title" placeholder="Name"/>
                                                   </div>
                                                   <div class="col-md-12 mb-3">
                                                      <label for="subheading">Designation</label>
                                                      <input type="text" class="form-control" id="designation" name="designation" value="{{$t->designation}}" placeholder="Designation"/>
                                                   </div>
                                                   <div class="col-md-12 mb-3">
                                                      <label>Comment</label>
                                                      <textarea class="form-control" id="comment" name="comment">{{$t->comment}}</textarea>
                                                   </div>
                                                   <div class="col-md-12 mb-3">
                     ...
                     <script>
                        $('#update-button{{$t->id}}').click(function() {
                            ...
                            var formData = new FormData(document.getElementById("edit-testimonial-form{{$t->id}}"));
                            $.ajaxSetup({
                                headers: {
