                                 ...
                                 <div class="row">
                                    <div class="col-12">
                                       <div class="">
                                          <div class="">
                                            <div id="message"></div>
                                             <form id="variants-form" enctype="multipart/form-data">
                                                <div class="row">
                                                   ...
                                                   <div class="col-md-12 mb-3">
                                                      ...
                                                      <input type="color" class="form-control" id="code" name="code" placeholder="Color Code"/>
                                                   </div>
                                                </div>
                  ...
                  <table
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <a href="{{url('admin/delete/'.base64_encode($t->id).'/'.base64_encode('variants'))}}" class="btn btn-danger delete  py-8 mb-4 rounded-2"><i class="fa fa-trash"></i></a>
                           <div
                        class="modal fade"
                        id="bs-example-modal-lg{{$t->id}}"
                        tabindex="-1"
                        aria-labelledby="bs-example-modal-lg{{$t->id}}"
                        aria-hidden="true"
                        >
                        <div class="modal-dialog modal-l">
                           <div class="modal-content">
                                 ...
                                 <div class="row">
                                    <div class="col-12">
                                       <div class="">
                                          <div class="">
                                            <div id="message"></div>
                                             <form id="edit-variants-form{{$t->id}}" data-item-id="{{ $t->id }}" enctype="multipart/form-data">
                                                <div class="row">
                                                   <div class="col-md-12 mb-3">
                                                      ...
                                                      <!-- @method('PUT') -->
                                                      <label for="title">Title</label>
                                                      <input type="text" class="form-control" id="title" value="{{$t->title}}" name="title" placeholder="Title"/>
                                                   </div>
                                                   <div class="col-md-12 mb-3">
                                                      <label for="title">Color Code</label>
                                                      <input type="color" class="form-control" id="code" value="{{$t->code}}" name="code" placeholder="Color Code"/>
                                                   </div>
                                                </div>
                                                <button id="update-button{{$t->id}}" type="button" class="btn btn-info rounded-pill px-4 mt-3">
                                                Add {{$page_title}}
                                                </button>
                                             </form>
                                          </div>
                     ...
                     <script>
                        $('#update-button{{$t->id}}').click(function() {
                            event.preventDefault();
                            var formData = new FormData(document.getElementById("edit-variants-form{{$t->id}}"));
                            $.ajaxSetup({
                                headers: {
...
<script>
   $(document).ready(function() {
     $('#variants-form').on('submit', function(event) {
         event.preventDefault();
